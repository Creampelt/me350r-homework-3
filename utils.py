...
def velocity_analysis(l2, l3, w2, theta2, theta3, theta4):
    answers = np.array(
        [np.sin(theta4 - theta2) / np.sin(theta3 - theta4), np.sin(theta2 - theta3) / np.sin(theta4 - theta3)])
    # Returns w3, w4
    return l2 * w2 / l3 * answers
...
def slider_crank_velocity_analysis(l2, l3, l4, w2, theta2, crossed=False):
    _, theta3 = slider_crank_vector_loop(l2, l3, l4, theta2, crossed)
